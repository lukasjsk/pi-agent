...
End with `## Handover` containing the same facts, constraints, and exact `path:line-range` references in a compact form. This handover is automatically supplied to downstream agents; do not omit it.
